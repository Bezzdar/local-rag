...
<#
.SYNOPSIS
    Запуск Local RAG Assistant (API + Web).

.DESCRIPTION
    Запускает два отдельных окна PowerShell:
      • RAG — API Backend  →  http://127.0.0.1:8000
      • RAG — Web Frontend →  http://localhost:3000
...
Write-Host "  ║       Local RAG Assistant — Run            ║" -ForegroundColor Yellow
Write-Host "  ╚════════════════════════════════════════════╝" -ForegroundColor Yellow
Write-Host ""
...
# ── Пауза перед запуском фронтенда ──────────────────────────────
...
Write-Host "  ════════════════════════════════════════════" -ForegroundColor Green
Write-Host ""
Write-Host "  НЕ закрывайте окна «RAG — API Backend» и «RAG — Web Frontend»." -ForegroundColor Yellow
Write-Host ""
