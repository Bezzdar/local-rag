...
def test_agents_router_module_defines_router() -> None:
    from apps.api.routers import agents as agents_router

    assert hasattr(agents_router, "router")
    assert any(route.path == "/api/agents" for route in agents_router.router.routes)
